...
/**
    ...
    FiveWire.cpp. Whether the host counts in seconds or milliseconds decides
    whether a hum bar crawls or flickers and whether an unlocked frame rolls or
    tears, and there is no way to see which the host chose from inside the
    picture.
*/
namespace fivewire::diag
{

...
bool PassBuffer::Ensure( GLsizei requestedWidth, GLsizei requestedHeight, GLint format )
{
	...
	//A freshly allocated framebuffer's contents are undefined, and the compose
	//pass reads the reduced buffers on frames where nothing wrote them.
	//Undefined there is not a subtle artefact: it is whatever texture memory

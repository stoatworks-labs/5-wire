/**
    ...
    `CFFGLPluginInfo` that FiveWire.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings FiveWire.bundle/Contents/MacOS/FiveWire | grep 5-wire
*/

extern "C" const char* FiveWireBuildStamp()
{
	return "5-wire " FIVEWIRE_VERSION " built " __DATE__ " " __TIME__;
}

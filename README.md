...
**[v0.1.3](https://github.com/stoatworks-labs/5-wire/releases/tag/v0.1.3)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`5-wire-0.1.3-macos-universal.dmg`](https://github.com/stoatworks-labs/5-wire/releases/download/v0.1.3/5-wire-0.1.3-macos-universal.dmg) | 219 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`5-wire-macos-universal.zip`](https://github.com/stoatworks-labs/5-wire/releases/latest/download/5-wire-macos-universal.zip) | 182 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`5-wire-0.1.3-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/5-wire/releases/download/v0.1.3/5-wire-0.1.3-windows-x86_64-setup.exe) | 223 KB |

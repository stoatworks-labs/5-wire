...
**[v0.1.4](https://github.com/stoatworks-labs/5-wire/releases/tag/v0.1.4)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`5-wire-0.1.4-macos-universal.dmg`](https://github.com/stoatworks-labs/5-wire/releases/download/v0.1.4/5-wire-0.1.4-macos-universal.dmg) | 219 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`5-wire-0.1.4-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/5-wire/releases/download/v0.1.4/5-wire-0.1.4-windows-x86_64-setup.exe) | 223 KB |

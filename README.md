...
Prebuilt binaries appear here once the first release has been published; this
block is generated by `stoatworks-backend/release/gen-downloads.py` and must not
be hand-edited. Until then, build it yourself below.
